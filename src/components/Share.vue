<template>
  <div>
    <div class='share-container'><a href='#' @click.prevent='openDialog' class='open-share-dialog secondary-text'>...share</a></div>
    <div v-if='isOpened' class='share-dialog primary-text' @click='hide'>
      <div class='share-window secondary-border darker-background' ref='shareWindow'>
        <h2>Share link</h2>
